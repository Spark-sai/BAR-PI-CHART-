...
public class ShipmentServiceImple implements IShipmentService {
	...
	public Shipment GetOneShipment(Integer id) {
		return repo.findById(id).orElseThrow(() -> new ShipmentNotFoundException("Shipment not '" + id + "' Found"));
	}
	...
	public void deleteShipment(Integer id) {
		...
		if (s.isPresent())
			...
			throw new ShipmentNotFoundException("Shipment is not Found");

	}
	
	
	/**
	 * this method check the count of ShipmentCode exit or not 
	 */
